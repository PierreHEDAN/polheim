...
const SvgComponent = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={122} height={89.99} viewBox="0 0 122 89.99" preserveAspectRatio="xMinYMin slice" {...props}>
    <defs>
      <clipPath id="a">
        <path data-name="Rectangle 297" fill="#00374B" d="M0 0h122v89.99H0z" />
      </clipPath>
    </defs>
    <g data-name="Groupe 1890" clipPath="url(#a)" fill="#00374B" opacity={0.5}>
      <path
