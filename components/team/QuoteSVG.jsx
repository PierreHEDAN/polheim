...
const SvgComponent = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={18} viewBox="0 0 122 89.99" preserveAspectRatio="xMinYMin slice" {...props}>
    <defs>
      <clipPath id="a">
        <path data-name="Rectangle 297" fill="#73C3D0" d="M0 0h122v89.99H0z" />
      </clipPath>
    </defs>
    <g data-name="Groupe 1890" clipPath="url(#a)" fill="#73C3D0">
      <path
