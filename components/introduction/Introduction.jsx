  ...
  <div className={styles.container}>
    <div className={styles.content}>
      ...
      <div className={styles.paragraph}>
        ...
        <p className="primary">
          L’expédition Polheim est l’entreprise d’une aventure folle. Atteindre le Pôle Sud en autonomie et sans moyen de traction depuis les côtes de l’Antarctique, une expédition de 650 kilomètres sur plus de 40 jours dans des conditions extrêmes.
          <br />
          <br />
