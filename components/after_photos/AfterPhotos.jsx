      ...
      <div className={styles.content}>
        <div className={styles.photos}>
          <div className={styles.instaContainer}>
            <InstaPhoto
              key="image1"
              src={require('../../public/assets/images/after_photos/coming_soon.png')}
          ...
          <div className={styles.instaContainer}>
            <InstaPhoto
              key="image2"
              src={require('../../public/assets/images/after_photos/2.jpg')}
              className={styles.insta}
              onOpenImage={onOpenImage}
          ...
          <div className={styles.instaContainer}>
            <InstaPhoto
              key="image3"
              src={require('../../public/assets/images/after_photos/1.jpg')}
              className={styles.insta}
              onOpenImage={onOpenImage}
