  ...
  <div className={styles.container}>
    <div className={styles.content}>
      <div className={styles.paragraph}>
        ...
        <p className="primary">
          Pierre HEDAN est le pilote de ce projet et le futur Homme de terrain de l’expédition Polheim : « ingénieur en devenir de 24 ans, j’aime découvrir des univers épurés et évoluer là où toute ressource est limitée, renouer avec la sobriété.
          <br />
          <br />
          Ascension du Mont Blanc, treks hivernaux en Laponie, atteinte du sommet du Kilimandjaro, tout ce parcours m’a permis de prendre du recul et de gagner en maturité. À travers ma formation de guide polaire, j’aime partager mes connaissances et mon expérience. J’affectionne tout particulièrement cette idée : “A chacun son Everest”, il faut croire en ses rêves et bien s’entourer pour se donner les moyens d’y arriver.
          <br />
          <br />
