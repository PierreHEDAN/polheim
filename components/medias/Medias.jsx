...
const slides = [
  ...
  <Card key={4} name="Passeport Armorique" imgSrc="/assets/images/medias/passport.png" link="https://www.passeport-armorique.com/pierre-hedan-explorateur-polaire/" />,
  <Card key={5} name="Betton Info" imgSrc="/assets/images/medias/betton.png" link="https://www.betton.fr/upload/espace/12/pj/6916_15700_BI___juin_2021_BAT___72_dpi.pdf" />,
  <Card key={6} name="Espace Monde Polaires" imgSrc="/assets/images/medias/espace.png" link="https://www.espacedesmondespolaires.org/event/le-metier-de-guide-polaire/" />,
  <Card key={7} name="Rennes Métropole" imgSrc="/assets/images/medias/rennes.jpg" link="https://fr.calameo.com/read/005416234c1c64fd8b0f9?page=40" />,
];
